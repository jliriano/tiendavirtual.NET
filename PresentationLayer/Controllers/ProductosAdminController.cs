...
namespace PresentationLayer.Controllers
{
    public class ProductosAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,nombre,descripcion,precio,cantidad,fotoUri")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,nombre,descripcion,precio,cantidad,fotoUri")] Producto producto)
        {
            if (ModelState.IsValid)
            {
